...
El ciberataque perpetrado por el grupo Rhysida al Ejército de Chile en mayo de 2023 constituye un punto de inflexión en la gestión de la seguridad de la información del Estado. Más allá del impacto técnico y operacional inmediato, este incidente deja **tres conclusiones jurídicas y estratégicas fundamentales**:

### 1. Coexistencia de Responsabilidades y Riesgo Interno (*Insider Threat*)
El caso demuestra que la ciberseguridad no es un problema exclusivamente externo. La persecución del delito exige activar de forma simultánea múltiples esferas del derecho:
* **Vía penal transnacional:** Para los atacantes extranjeros (mediante la Ley 21.459 y el Convenio de Budapest).
* **Vía administrativa y civil:** Para la institución pública por *falta de servicio*.
* **Justicia militar:** Para sancionar la presunta complicidad interna (el cabo investigado).

>**Lección Estratégica:** Esto evidencia que las mayores brechas suelen originarse en la combinación de fallas perimetrales y debilidades en el control del personal interno.
